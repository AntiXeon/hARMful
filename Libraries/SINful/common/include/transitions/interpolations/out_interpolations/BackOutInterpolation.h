#ifndef __SIN_BACK_OUT_INTERPOLATION__
#define __SIN_BACK_OUT_INTERPOLATION__
...
namespace Sin {
     ...
     *          <b>y(x) = 1 - (x^2 * ((s + 1) * x - s))</b> for x in [0;1] and s
     *          being the overshoot factor.
     * @author  CB (c) 2016
     * @version 0.1     2016/02/09
     */
    class BackOutInterpolation : public IInterpolation {
        private:
            /**
        ...
        public:
            /**
             * @brief   Create a BackOutInterpolation.
             * @param   overshoot   Factor of the back effect.
             */
            BackOutInterpolation(const Mind::Scalar& overshoot = 1.5f) ;

            /**
             * @brief   Destruction of the BackOutInterpolation.
             */
            virtual ~BackOutInterpolation() ;
