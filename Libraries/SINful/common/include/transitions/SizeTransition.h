...
namespace Sin {
    ...
    /**
     * @brief   Animated elements on their size.
     * @author  CB (c) 2016
     * @version 0.1     2016/02/09
     */
    class SizeTransition : public AbstractTransition {
        public:
             ...
             *                          intermediary values.
             */
            SizeTransition(const int& last, IInterpolation* interpolation) ;

            /**
             * @brief   Destruction of the SizeTransition.
             */
            virtual ~SizeTransition() ;
