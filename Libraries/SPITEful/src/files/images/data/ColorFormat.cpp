...
namespace Spite {
    ...
    ColorFormat::ColorFormat() : m_isInitialized(false) {}
    ...
    void ColorFormat::Create(const ColorFormat::ID& id) throw (Doom::UnexpectedValueException) {
    ...
    const std::string& ColorFormat::getName() const {
        return m_name ;
    }

    unsigned char ColorFormat::getAmountOfComponents() const {
        return m_componentMasks.size() ;
    }

    unsigned char ColorFormat::getPixelSizeInBytes() const {
        return m_pixelSize ;
    }

    unsigned char ColorFormat::getColorDepth() const {
        return m_colorDepth ;
    }

    unsigned char ColorFormat::getComponentSize() const {
        return m_componentSize ;
    }

    unsigned int ColorFormat::getMask(const unsigned int& componentID) const {
        ...
        switch (id) {
            ...
            default:
                ThrowException(
                               ...
                               ColorFormatMsg::Error::UnknownFormat
                              ) ;
                break ;
        }
    }
