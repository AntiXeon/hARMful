...
namespace Hope::GL {
    ...
    class Framebuffer2DMultisample final : public Framebuffer {
        private:
             ...
             */
            std::vector<std::unique_ptr<TextureImage2DMultisample>> m_colorAttachments ;

            /**
             * Depth buffer attachment.
             */
            std::unique_ptr<TextureImage2DMultisample> m_depthAttachment ;

            /**
             * Stencil buffer attachment.
             */
            std::unique_ptr<TextureImage2DMultisample> m_stencilAttachment ;

            /**
             * Depth + stencil buffer attachment.
             */
            std::unique_ptr<TextureImage2DMultisample> m_depthStencilAttachment ;

        public:
            /**
             * Create a new Framebuffer2D instance.
             */
            exported Framebuffer2DMultisample() ;
