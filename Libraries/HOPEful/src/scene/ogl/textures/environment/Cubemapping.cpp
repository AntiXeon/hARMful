...
std::array<Cubemapping::CoordsCubeFaces, Cubemapping::AmountFaces> Cubemapping::CoordinatesFaces(const Cubemapping::CubemapType type) {
...
GLenum Cubemapping::GLCoordinates(const CubeFaces face) {
    switch (face) {
        case CubeFaces::Left:
