...
void SSAOMaterialComponent::updateUniformValues() {
    ...
    framebuffer -> bindUnitColor(SSAORenderNode::AlbedoRenderTarget) ;
    framebuffer -> bindUnitColor(SSAORenderNode::NormalRenderTarget) ;
    framebuffer -> bindUnitDepth(SSAORenderNode::DepthRenderTarget) ;
}
