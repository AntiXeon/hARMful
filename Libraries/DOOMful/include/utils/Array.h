...
/* UPDATE:      01/10/2016                 */
/*                                         */
/* Array as an object with a fixed size    */
/* and type.                               */
/*******************************************/

#ifndef __DOOM_ARRAY__
#define __DOOM_ARRAY__
...
namespace Doom {
   ...
   /**
    * @brief   Array as an object with a fixed size and type.
    * @author  CB (c) 2016
    ...
    */
    ...
    class Array {
        ...
        public:
            ...
            /**
             * @brief   Destruction of the Array.
             */
            virtual ~Array() ;
             ...
             */
            Array<Type, Size>& operator=(const Array<Type, Size>& other) ;
             ...
             * @warning Pointers are just copied, pointed objects are not cloned.
             */
            Array<Type, Size>& operator=(const Type* other) ;
    } ;

    #include "Array/Array.impl"
