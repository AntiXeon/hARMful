    ...
    namespace EmulatedSIMD {
        ...
        class Vector4f {
            ...
            public:
                 ...
                 * @param      other     The other Vector4f to compute dot
                 *                       product.
                 ...
                 * case:
                 * <code>dst[i] = selector[i] ? a[i] : b[i] ;</code>
                 * @param     selector     Mask to select elements from a if
                 *                         TRUE, from b if FALSE.
                ...
                /**
                 * Compute for each element of @a vec 1 / sqrt(@a vec[i]).
                 * The maximum relative error for this approximation is less
                 * than 1.5*2^-12.
                ...
                static void transposeMatrix(
                    ...
                    Vector4f& row4
                                                     ...
                                                     /*** GETTERS / SETTERS ***/
                /**
                 * Get a Mask in which elements are TRUE for negative element in
                 * the current Vector4f, FALSE for positive elements in the
                 * current Vector4f.
                ...
                /**
                 * Get a Mask in which elements are TRUE for infinite values in
                 * current Vector4f, FALSE for finite values.
                 * @return    A Mask containing TRUE for infinite elements in
                 *            the current Vector4f.
                 */
                Mask isInfinite() ;
            ...
            protected:
                 ...
                 * the extremely time-consuming denormals in case of underflow.
                 */
            ...
            public:
                ...
                /**
                 * Get the values from a Vector4i (integers) and put it in inner
                 * data.
        ...
        Vector4f& Vector4f::shuffle(
            ...
            for (unsigned int index = 0 ; index < size() ; ++index) {
                output.m_inner[index] = tmp[Indices[index]] ;
            }
