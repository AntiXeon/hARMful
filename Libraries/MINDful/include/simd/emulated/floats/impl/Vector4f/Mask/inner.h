/**
 * @brief 	Mask to perform logical operations on Vector4f.
 */
class Mask {
	private:
		/** @brief 	Inner vector of booleans (as floats). */
		float32x4_t m_inner ;
    ...
    public:
        ...
        /**
         * @brief   Create from a Mask used by integer Vector4.
	...
	protected:
		/**
		 * @brief 	Copy the binary value from integer to float.
		...
		/**
		 * @brief 	Copy the binary value from float to integer.
		 * @param 	value 	Value to copy.
		 * @return 	Integer containing the same binary value as the input float
		 *			value.
		 */
		static uint32_t binaryConvert(float value) ;
	...
	public:
        ...
        /**
         * @brief   Cast the current Mask to a float32x4_t.
        ...
        /**
         * @brief   Cast the current Mask to a Vector4i::Mask.
         * @return  The Vector4i::Mask version of the current Mask.
         */
        operator Vector4i::Mask() const ;

        /**
         * @brief   Cast the current Mask to a Vector4ui::Mask.
