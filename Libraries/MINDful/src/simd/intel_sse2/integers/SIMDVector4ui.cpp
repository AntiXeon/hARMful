...
namespace Mind {
    ...
    namespace SSE2 {
        ...
        //static Vector4ui operator<<(const Vector4ui& vec, int32_t bits) {
        //    return _mm_sll_epi32(vec,_mm_cvtsi32_si128(bits)) ;
        //}

        //static Vector4ui& operator<<=(Vector4ui& vec, int32_t bits) {
        //    vec = vec << bits ;
        //    return vec ;
        //}
        ...
        //static Vector4ui operator==(const Vector4ui& a, const Vector4ui&b) {
