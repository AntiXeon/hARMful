...
namespace Mind {
    ...
    void SquareMatrixf::copy(const SquareMatrixf& copied) {
        int maxSize = Math::min(m_size, copied.m_size) ;
    ...
    float* SquareMatrixf::operator[](int index) {
        return m_data[index] ;
    }
